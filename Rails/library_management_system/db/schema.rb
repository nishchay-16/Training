...
ActiveRecord::Schema[7.1].define(version: 2024_07_19_091940) do
  ...
  create_table "books_authors_join_table", id: false, force: :cascade do |t|
    t.bigint "book_id", null: false
    t.bigint "author_id", null: false
    t.index ["author_id"], name: "index_books_authors_join_table_on_author_id"
    t.index ["book_id"], name: "index_books_authors_join_table_on_book_id"
  end
